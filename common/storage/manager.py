...
async def init_database():
    ...
    await cur.executescript(f"""
                    ...
                    CREATE TABLE IF NOT EXISTS guild_member_log(
                        ...
                        entry_type INTEGER CHECK(entry_type IN {tuple(t.value for t in common.types.enums.LogEntryType)}) NOT NULL,
                    ...
                    CREATE INDEX IF NOT EXISTS wars_idx ON player_tracking (uuid, record_time, wars) WHERE wars > 0;
    """)
